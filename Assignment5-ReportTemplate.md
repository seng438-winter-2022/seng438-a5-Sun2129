...
The Purpose of this lab is the analysis of integration testing for a hypothetical system when providing its failure data using various reliability assessment tools such as Reliability growth testing and Reliability assessment using Reliability Demonstration Chart (RDC). We used C-SFRAT and Excel to analyze the test data to create various models to get the  failure rate, MTTF, and reliability of SUT. 
